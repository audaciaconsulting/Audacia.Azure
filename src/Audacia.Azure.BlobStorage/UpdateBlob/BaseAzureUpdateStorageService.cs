...
#pragma warning disable AV1564,ACL1017
        bool doesContainerExist,
#pragma warning restore AV1564,ACL1017
        CancellationToken cancellationToken)
    {
        return !doesContainerExist
            ? await CreateContainerAsync(containerName, cancellationToken).ConfigureAwait(false)
